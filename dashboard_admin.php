...
<head>
    ...
    <title>Dashboard Administrador - Vetvital</title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            <ul>
                <li><a href="dashboard_admin?page=inicio" class="<?php echo $page == 'inicio' ? 'active' : ''; ?>"><i class="fa-solid fa-chart-pie"></i> Dashboard</a></li>
    ...
    <main class="main-content">
        <header class="topbar">
            ...
            <div class="topbar-welcome">
                ¡Hola, <?php echo htmlspecialchars($_SESSION['nombre']); ?>! <i class="fa-solid fa-hand"></i>
            </div>
        </header>
        ...
        <div class="content-container">
            ...
            <?php if ($page == 'inicio'): ?>
                <div class="welcome-card">
                    <h2>Bienvenido/a al Centro Clínico Veterinario</h2>
                    <p>Desde aquí puedes administrar los accesos, revisar las estadísticas del día y coordinar los módulos principales.</p>
                </div>
                ...
                <div class="table-header-container" style="margin-top: 40px; margin-bottom: 15px;">
                    <h2><i class="fa-solid fa-calendar-day" style="color: #115e59; margin-right: 8px;"></i> Agenda para el Día de Hoy</h2>
                </div>
                            ...
                            ?>
                                <tr>
                                    <td colspan="5" style="text-align: center; padding: 30px;" class="text-muted">
                                        ...
                                        No hay citas programadas para el día de hoy. ¡Un día tranquilo!
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
